...
PassRouter.post('/api/v1/passwords', passwordLimiter, PasswordController.savePassword);
...
PassRouter.put('/api/v1/passwordslist/:id', passwordLimiter, PasswordController.updatePassword);
